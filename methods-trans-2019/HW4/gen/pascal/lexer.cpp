...
token next_token_ext() {
  while (true) {
    if (str_matches("[ \t\n]+") and matcher.position(0) == 0) {
      ...
      continue;
    } else if (str_matches("and") and matcher.position(0) == 0) {
      cur_string = matcher.str();
      cur_pos += cur_string.length();
      ...
      continue;
    } else if (str_matches("or") and matcher.position(0) == 0) {
      cur_string = matcher.str();
      cur_pos += cur_string.length();
      ...
      continue;
    } else if (str_matches("xor") and matcher.position(0) == 0) {
      cur_string = matcher.str();
      cur_pos += cur_string.length();
      ...
      continue;
    } else if (str_matches("not") and matcher.position(0) == 0) {
      cur_string = matcher.str();
      cur_pos += cur_string.length();
      ...
      cur_pos += cur_string.length();
       ...
       cur_unio.t = new tree(cur_string); return VAR; 
