...
// Ideas
// TODO: think about duplicating root_node? Deprecate it?
// TODO: think about using statistics about проходы по ноде (собрать в тестах?)
int main(int argc, char** argv) {
  ...
  while (time_spented() < 60 * 9) {
    ...
    */
    ...
    // std::cout << "best : " << best_total << std::endl;
  }
